...
class WalletBalanceBeforeWithdrawalEvent extends Event
{
    public const NAME = 'wallet.balance_before_withdrawal';
    ...
    /**
     * WalletBalanceBeforeWithdrawalEvent constructor.
     * @param Wallet $wallet
