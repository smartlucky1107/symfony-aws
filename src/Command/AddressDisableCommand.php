...
class AddressDisableCommand extends Command
{
    protected static $defaultName = 'app:address:disable';
    ...
    /**
     * AddressDisableCommand constructor.
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if(is_null($currencyId)){
            $this->addressRepository->disableAll();
        }else{
