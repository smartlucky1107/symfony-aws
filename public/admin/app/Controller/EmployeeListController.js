function EmployeeListController($scope, api, listManager, routingModule, bridge){
    $scope.routing = routingModule;

    listManager.initFilterFields(['id', 'firstName', 'lastName']);
    ...
    let refreshList = function(){
        ...
        api.getEmployees(listManager.options, function (result) {
