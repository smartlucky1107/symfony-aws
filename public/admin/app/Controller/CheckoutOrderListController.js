function CheckoutOrderListController($scope, api, listManager, routingModule, bridge){
    $scope.routing = routingModule;

    listManager.initFilterFields(['id']);
    listManager.initSortBy('createdAt');
    ...
    let refreshList = function(){
        ...
        api.getCheckoutOrders(listManager.options, function (result) {
